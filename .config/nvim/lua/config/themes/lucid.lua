...
local spec = lush(function()
  return {
    ...
    DiffDelete { fg = "blue", gui = "bold", bg = "darkcyan", },
    DiffText { gui = "bold", bg = "red", },
    ...
    Pmenu { fg = colors.cloud, bg = colors.rock_medium, },
    NormalFloat { Pmenu },
    ...
    GitGutterAdd { fg = colors.turquoise },
    GitGutterChange { fg = colors.sap },
    GitGutterDelete { fg = colors.pink },
