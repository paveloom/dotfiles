...
function M.cmap(k, e) map("c", k, e) end

-- Map a keybinding in the insert mode
function M.imap(k, e) map("i", k, e) end

-- Map a keybinding in the normal mode
function M.nmap(k, e) map("n", k, e) end

-- Map a keybinding in the visual mode
function M.vmap(k, e) map("v", k, e) end

-- Map a keybinding in the visual and select modes
function M.xmap(k, e) map("x", k, e) end
...
function M.add_lang(id)
    ...
    if not M.known({ "curl" }) then return end
